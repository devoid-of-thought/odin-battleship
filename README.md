...
After sinking ship all cells around it will be marked, because placing ship there is not possible. 
Computer will make **random** choice until something is hit, then it will try to sink the ship it struck.


![Game](./images/game.png)

After a lost game unsunken ships will become visible. 

![After Game](./images/after-game.png)
